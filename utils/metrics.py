...
from modules.ctc_decoding import AbstractCTCDecoding, CTCBPEDecoding
from modules.rnnt_decoding import AbstractRNNTDecoding
...
class WER(Metric):
    ...
    def __init__(
        ...
        elif isinstance(self.decoding, CTCBPEDecoding):
